...
export const ME = {
    ...
    contactInfo: {
        email: "alfonso.sanchez.ruizz@gmail.com",
        linkedin: "https://www.linkedin.com/in/alfonsosanchezruiz",
        resumeDoc: "resume.pdf",
    },
    aboutMe: "Soy FullStack Software Developer y me apasiona el desarrollo web. Tengo experiencia en la creación de sitios web y" + "aplicaciones que utilizan tecnologías modernas. Soy un desarrollador autodidacta que disfruta aprendiendo cosas nuevas y " + "compartiendo conocimientos con otros.",
}
```
---
